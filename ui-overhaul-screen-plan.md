...
- **Hint = `HintBubble.jsx`:** the hint renders as Tinku's speech bubble (tail pointing to him), animates in (pop/slide, opacity+transform), clearly THE teaching moment. (Representation already improved — this makes it fully on-design.)
