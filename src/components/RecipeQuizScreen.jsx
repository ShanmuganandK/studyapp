 ...
 */
export default function RecipeQuizScreen({ grade = 1, skillId, onBack, bridgeEnabled = false }) {
  return <SessionPlayer grade={grade} skillId={skillId} onExit={onBack} bridgeEnabled={bridgeEnabled} />;
}
