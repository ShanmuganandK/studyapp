...
- **Mastery tracker** — promotion/demotion thresholds (~80% at hard; `level` and `difficulty`
  each need consecutive strong sessions, one weak session drops either — DECISIONS 2026-09-01),
