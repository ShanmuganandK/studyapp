...
const ALL_SKILLS = [
  ...
  skill('g2.add.2d-nocarry', '2-digit addition, no carry', 2, 'addition', 110, 3, ['g1.add.within20', 'g1.place.tens-ones'], 'addition2d', 'ready',
    // strategyRungs: this skill's rungs are a strategy order, not a magnitude cap (DECISIONS
    // 2026-08-27) — the property that opts a skill into the bridge-in walk (DECISIONS
    // 2026-09-22, behind the parent-zone test toggle). A skill-map property, never a skillId
    // literal in useQuizSession.js, so #13 (generalising strategy rungs) can add skills here.
    { displayName: 'Two-Digit Adds', subtitle: '2-digit addition', icon: '🧮', strategyRungs: true }),
  skill('g2.add.2d-carry', '2-digit addition with carry', 2, 'addition', 111, 3, ['g2.add.2d-nocarry'], 'addition2d', 'ready',
    { displayName: 'Carry the Ten', subtitle: '2-digit addition with carry', icon: '🎒' }),
  skill('g2.sub.2d-noborrow', '2-digit subtraction, no borrow', 2, 'subtraction', 120, 3, ['g1.sub.within20', 'g1.place.tens-ones'], 'subtraction2d', 'ready',
    { displayName: 'Two-Digit Take-Away', subtitle: '2-digit subtraction', icon: '➖' }),
  skill('g2.sub.2d-borrow', '2-digit subtraction with borrow', 2, 'subtraction', 121, 3, ['g2.sub.2d-noborrow'], 'subtraction2d', 'ready',
    { displayName: 'Borrow a Ten', subtitle: '2-digit subtraction with borrow', icon: '🤝' }),
  skill('g2.mul.intro', 'Multiplication as repeated addition', 2, 'multiplication', 130, 2, ['g1.add.within20'], 'mulIntro', 'ready',
    { displayName: 'Groups of Things', subtitle: 'Multiplication as repeated addition', icon: '🧺' }),
  skill('g2.mul.table2', 'Table of 2', 2, 'multiplication', 131, 3, ['g2.mul.intro'], 'mulTable', 'ready',
    { displayName: 'Table of 2', subtitle: 'Twos table', icon: '2️⃣' }),
  skill('g2.mul.table5', 'Table of 5', 2, 'multiplication', 132, 3, ['g2.mul.intro'], 'mulTable', 'ready',
    { displayName: 'Table of 5', subtitle: 'Fives table', icon: '5️⃣' }),
  skill('g2.mul.table10', 'Table of 10', 2, 'multiplication', 133, 3, ['g2.mul.intro'], 'mulTable', 'ready',
    { displayName: 'Table of 10', subtitle: 'Tens table', icon: '🔟' }),
